    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <?php
            $id = $_SESSION['id'];
            $sql = "select nm_pasien from pasien where id_pasien='".$id."'";
            $query = mysql_query($sql);
            while($data = mysql_fetch_array($query)){
              echo  "<br><p style='text-transform:capitalize'>" .$data['nm_pasien']. "</b></p>";
            }
          ?>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=pfl"><i class="fa fa-user"></i> <span>Profil</span></a></li>
